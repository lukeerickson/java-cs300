...
/**
 * AddBlueFishButton describes the constructor and methods of a button that adds a blue fish to the
 * tank
 * 
 * @author Luke Erickson
 *
...
public class AddBlueFishButton extends Button {
   ...
   * adds the button to the objects arrayList
   */
  @Override
  public void mousePressed() {
    this.tank.addObject(new BlueFish());
  }
