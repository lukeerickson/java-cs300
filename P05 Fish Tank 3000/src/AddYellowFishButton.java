...
/**
 * AddYellowFishButton describes the constructor and methods of a button that adds a yellow fish to the tank
 * 
 * @author Luke Erickson
 *
 */
...
public class AddYellowFishButton extends Button {
  ...
  public void mousePressed() {
    this.tank.addObject(new Fish(2, "images" + File.separator + "yellow.png"));
  }
