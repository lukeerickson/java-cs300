...
public class Book {
  ...
  /**
   * Determines if two book objects are identical
   * 
   * @param o object to be compared against
   * @return true if both book objects are identical
   */
  @Override
  public boolean equals(Object o) {
    if(this.ID == ((Book) o).ID && this.title.equals(((Book) o).getTitle()) && this.getAuthor().equals(((Book) o).getAuthor()) && this.pageCount == ((Book) o).getPageCount())
      return true;
    return false;
  }
